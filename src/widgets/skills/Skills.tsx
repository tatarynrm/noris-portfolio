    ...
    return (
        <section id="skills" className="py-32 relative z-10">
            <div className="container mx-auto px-6">
                <h2 className="text-5xl font-extrabold text-center mb-20 tracking-tighter text-gray-900 dark:text-white">
                    {t("title_1")} <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-indigo-500">{t("title_2")}</span>
                </h2>
                    ...
                    {skillsData.map((skill, index) => (
                        ...
                        >
                            <HoverTilt intensity={12}>
                                <div
                                    className="skill-card p-10 rounded-3xl backdrop-blur-xl bg-white dark:bg-black/40 border border-gray-200/80 dark:border-white/10 hover:border-blue-400/60 dark:hover:border-blue-500/50 transition-all duration-500 group shadow-[0_4px_24px_rgba(0,0,20,0.06)] hover:shadow-[0_8px_32px_rgba(59,130,246,0.15)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.2)] dark:hover:shadow-[0_8px_32px_rgba(59,130,246,0.3)] relative overflow-hidden"
                                >
